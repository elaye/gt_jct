...
\paragraph{Présentation des résultats} Le tracé de la trajectoire obtenue est présenté sur la figure \ref{fir:t_3d}. On observe une trajectoire hélicoïdale qui correspond bien à l'idée que l'on peut se faire d'un guide d'électrons. Une fois émis, les électrons (qui possèdent les conditions initiales décrites précédemment), vont avoir une trajectoire hélicoïdale autour de l'axe $z$, à savoir le fil mis au potentiel $V_0$.
...
On utilise la méthode (vue au \ref{subsection:lol}) RK4 pour résoudre le système différentiel.
